...
func (app *application) Run(addr string) error {
	...
	r.HandleFunc("/user/votes", auth(app.ListUserVotes)).Methods("GET")
	r.HandleFunc("/posts/{post_id}/votes", auth(app.VotePost)).Methods("PUT")
	r.HandleFunc("/comments/{comment_id}/votes", auth(app.VoteComment)).Methods("PUT")
	r.HandleFunc("/posts/{post_id}/votes", auth(app.DeletePostVote)).Methods("DELETE")
	r.HandleFunc("/comments/{comment_id}/votes", auth(app.DeleteCommentVote)).Methods("DELETE")
